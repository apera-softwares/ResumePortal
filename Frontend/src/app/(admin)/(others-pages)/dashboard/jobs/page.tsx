...
export default function BrowseJobsPage() {
  ...
  const handleResumeUploadApply = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setRefreshTrigger((prev) => prev + 1); // trigger reload to fetch new profile
      } else {
  ...
  return (
    <>
      ...
      {/* ──── MODAL: UPLOAD RESUME & APPLY (No Profile Found) ──── */}
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-150 dark:border-gray-750 w-full max-w-lg rounded-2xl overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200 flex flex-col">
            ...
            <form onSubmit={handleResumeUploadApply} className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="border-2 border-dashed border-gray-200 dark:border-gray-750 rounded-2xl p-6 text-center bg-gray-50 dark:bg-gray-905 cursor-pointer relative hover:border-blue-400 dark:hover:border-blue-800 transition-colors">
                  <input
                    type="file"
                    accept=".pdf"
                    required
                  ...
                  <span className="block text-[10px] text-gray-400 mt-1">Maximum file size: 50MB</span>
                </div>
              </div>
