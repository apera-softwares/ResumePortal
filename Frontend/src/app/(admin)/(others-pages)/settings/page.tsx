        ...
        <div className="lg:col-span-9 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800/80 rounded-3xl p-6 sm:p-8 shadow-sm">
                  ...
                  <div
                    ...
                    className={`cursor-pointer group flex flex-col justify-between p-5 rounded-2xl border transition-all ${
                      theme === "light"
                        ...
                        : "border-gray-200 dark:border-gray-800 bg-white/40 dark:bg-gray-900/40 hover:border-gray-300 dark:hover:border-gray-750"
                    }`}
                  >
                    ...
                    return (
                      <div
                        ...
                        className={`cursor-pointer flex items-center justify-between p-4 rounded-xl border transition-all ${
                          isActive
                            ? "border-brand-500 bg-brand-500/[0.04] dark:bg-brand-500/10"
                            : "border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-750 bg-white/30 dark:bg-transparent"
                        }`}
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 flex items-center justify-center font-bold text-xs rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-350 font-sans">
                            Aa
                          </div>
                          <span className="text-sm font-semibold text-gray-900 dark:text-white" style={{ fontFamily: f.family }}>
                            {f.name}
                          </span>
                        </div>

                        {isActive && (
                          <span className="text-[9px] font-bold tracking-wider text-brand-600 dark:text-brand-400 uppercase bg-brand-500/10 dark:bg-brand-500/20 px-2 py-0.5 rounded border border-brand-500/20">
                            Active
                          </span>
                        )}
                      </div>
          ...
          {activeTab === "profile" && (
            <div className="space-y-8">
              ...
              {/* Avatar, Status & Date */}
              <div className="flex items-center gap-5 p-5 bg-brand-500/[0.03] dark:bg-brand-500/[0.06] rounded-2xl border border-brand-500/10 dark:border-brand-500/20">
                <div className="w-16 h-16 flex items-center justify-center rounded-full bg-gradient-to-br from-brand-500 to-indigo-650 text-white text-2xl font-black shadow-md">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-3 mt-1.5">
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 text-xs font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-100 dark:border-emerald-900/40 rounded-full">
              ...
              <form onSubmit={handleProfileSave} className="space-y-6">
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    disabled={saving}
                    className="px-6 py-3 bg-brand-500 hover:bg-brand-600 text-white font-semibold text-sm rounded-xl transition-all shadow-md shadow-brand-500/20 active:scale-[0.98] disabled:opacity-50"
                  >
              ...
              <div className="p-6 bg-gray-50 dark:bg-gray-950/40 border border-gray-200/50 dark:border-gray-800/40 rounded-2xl space-y-6">
                <div className="flex flex-wrap items-center justify-between gap-4">
                  <div>
                    ...
                    <h4 className="text-xl font-extrabold text-gray-900 dark:text-white mt-2.5">
