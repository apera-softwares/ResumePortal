    ...
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-40 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-4 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <button 
            onClick={() => router.push("/")} 
            className="px-5 py-2 text-sm font-semibold rounded-xl border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-750 transition-all shadow-sm"
          >
            Home
          </button>
        </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center p-1 rounded-full hover:bg-gray-55 dark:hover:bg-gray-800/70 transition-all cursor-pointer"
              >
                ...
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-[#111827] border border-gray-150 dark:border-gray-800 rounded-2xl shadow-xl py-2 z-50 animate-in fade-in slide-in-from-top-1 duration-150">
                    ...
                    <button
                      ...
                      className="w-full text-left px-4 py-2.5 text-xs font-semibold text-gray-700 dark:text-gray-205 hover:bg-gray-55 dark:hover:bg-gray-800/60 transition-all flex items-center gap-2 cursor-pointer"
                    >
